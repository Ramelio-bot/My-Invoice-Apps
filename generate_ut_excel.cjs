...
async function createMasterExcel() {
    ...
    shMhs.columns = [
        ...
        { header: 'Nama_Lengkap', key: 'nama', width: 25 },
        { header: 'NIK', key: 'nik', width: 20 },
        { header: 'Tempat_Tanggal_Lahir', key: 'ttl', width: 25 },
        { header: 'No_WA', key: 'wa', width: 15 },
        { header: 'Prodi', key: 'prodi', width: 20 },
        { header: 'Fakultas', key: 'fakultas', width: 10 },
        { header: 'UPBJJ', key: 'upbjj', width: 15 },
    ...
    shLog.columns = [
        { header: 'No_Kwitansi', key: 'no', width: 15 },
        { header: 'Tanggal_Transaksi', key: 'tgl', width: 15 },
        { header: 'Petugas_TU', key: 'petugas', width: 15 },
        { header: 'NIM', key: 'nim', width: 15 },
        { header: 'Masa_Registrasi', key: 'masa', width: 15 },
        { header: 'Komponen_Biaya', key: 'komponen', width: 20 },
        { header: 'Kode_Billing', key: 'billing', width: 15 },
    ...
    shInput.getCell('D5').value = 'UT-2026-0001';
    
    shInput.getCell('C7').value = 'NIM Mahasiswa:';
    shInput.getCell('D7').value = '041234567';
    ...
    shCetak.getCell('B12').value = 'Total:';
