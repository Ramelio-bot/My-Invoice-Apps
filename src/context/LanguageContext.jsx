...
const translations = {
    ID: {
        ...
        landing_faq_a1: 'Ya. Plan FREE tidak ada batas waktu. Upgrade hanya jika butuh fitur lebih.',
        landing_faq_q2: 'Bagaimana cara upgrade ke PRO atau ULTIMATE?',
        landing_faq_a2: 'Masuk ke menu Upgrade di dalam aplikasi, pilih plan, bayar via transfer bank atau QRIS.',
        landing_faq_q3: 'Apakah data saya aman?',
        landing_faq_a3: 'Data disimpan di server terenkripsi. Kami tidak pernah menjual data pengguna.',
        landing_faq_q4: 'Bisa pakai di HP, tablet, dan laptop?',
        landing_faq_a4: 'Ya, My Invoice berjalan di semua device via browser. Tidak perlu install aplikasi.',
        landing_faq_q5: 'Apakah ada masa trial untuk PRO/ULTIMATE?',
        landing_faq_a5: 'Ya, ada trial 14 hari untuk fitur PRO/ULTIMATE jika daftar via link promo.',
        landing_faq_q6: 'Bagaimana jika saya lupa password?',
        landing_faq_a6: 'Klik "Lupa Password" di halaman login, masukkan email, dan ikuti instruksi reset.',
        landing_faq_q7: 'Apakah invoice bisa dilihat klien tanpa daftar?',
        landing_faq_a7: 'Klien menerima PDF via WhatsApp/email. Fitur link publik sedang dikembangkan.',
        landing_faq_q8: 'Bagaimana cara menghubungi support?',
        landing_faq_a8: 'Via WhatsApp atau email di section Kontak di bawah halaman ini.',
    ...
    EN: {
        ...
        landing_faq_a1: 'Yes. FREE plan has no time limit. Upgrade only if you need more features.',
        landing_faq_q2: 'How to upgrade to PRO or ULTIMATE?',
        landing_faq_a2: 'Go to Upgrade menu in app, choose plan, pay via bank transfer or QRIS.',
        landing_faq_q3: 'Is my data safe?',
        landing_faq_a3: 'Data is stored on encrypted servers. We never sell user data.',
        landing_faq_q4: 'Can I use it on mobile, tablet, or laptop?',
        landing_faq_a4: 'Yes, My Invoice runs on all devices via browser. No installation needed.',
        landing_faq_q5: 'Is there a trial for PRO/ULTIMATE?',
        landing_faq_a5: 'Yes, 14-day trial for PRO/ULTIMATE if registered via promo link.',
        landing_faq_q6: 'What if I forget my password?',
        landing_faq_a6: 'Click "Forgot Password" on login page, enter email, follow reset instructions.',
        landing_faq_q7: 'Can clients view invoices without registering?',
        landing_faq_a7: 'Clients receive PDF via WhatsApp/email. Public link feature is in development.',
        landing_faq_q8: 'How to contact support?',
        landing_faq_a8: 'Via WhatsApp or email in the Contact section at the bottom.',
