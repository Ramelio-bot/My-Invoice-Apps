...
const translations = {
    ID: {
        ...
        landing_testi1_role: 'Owner Cafe',
        ...
        landing_unlimited_all: 'Unlimited Semua',
        landing_unlimited_desc: 'Invoice, kwitansi, PO, SPH tanpa batas',
        landing_wa_desc: 'Share invoice & struk ke WA klien',
        landing_csv_desc: 'Download laporan format PDF/Excel',
        landing_scan_desc: 'Scan barcode produk via kamera HP',
        landing_emp_desc: 'Manajemen kasir per karyawan',
        landing_voc_desc: 'Buat kode diskon pelanggan',
        landing_repf_desc: 'Omzet, produk terlaris, per kasir',
        landing_loyalty: 'Member Loyalty Program',
        landing_loyalty_desc: 'Program poin & reward pelanggan otomatis',
        landing_tax: 'Flexible Tax',
        landing_tax_desc: 'Pengaturan pajak biaya layanan fleksibel',
        landing_open_bills: 'Open Bills',
        landing_open_bills_desc: 'Simpan & kelola billing meja/draft',
        landing_hpp_desc: 'Hitung harga pokok penjualan akurat',
        landing_multi_desc: 'Kelola banyak cabang dalam 1 akun',
        landing_white_desc: 'Hapus branding, pakai logo sendiri',

        // Landing Pricing Extra
        landing_pricing_free_desc: 'Cocok untuk memulai bisnis kecil.',
        landing_pricing_pro_desc: 'Solusi profesional tanpa batas.',
        landing_pricing_ult_desc: 'Branding penuh untuk multi-cabang.',
        landing_pricing_start_free: 'Mulai Gratis',
        landing_pricing_choose_pro: 'Pilih PRO',
        landing_pricing_choose_ult: 'Pilih ULTIMATE',

        // Landing Contact Placeholders
        landing_contact_name_ph: 'John Doe',
        landing_contact_email_ph: 'john@example.com',
        landing_contact_msg_ph: 'Halo, saya ingin bertanya tentang...',
        ...
        up_lock_ult_t: 'Fitur ULTIMATE Terkunci',
        up_lock_ult_d: 'Fitur eksklusif ini hanya tersedia untuk paket ULTIMATE. Dapatkan akses penuh!',
    ...
    EN: {
        ...
        // but re-listed here for context as per the provided snippet.
        // The actual new keys are landing_legal, landing_policy, etc.
        // landing_nav_products: 'Products',
        // landing_nav_features: 'Features',
        // landing_nav_pricing: 'Pricing',
        // landing_nav_faq: 'FAQ',
        // landing_nav_contact: 'Contact Us', // Changed from 'Contact'
        // landing_nav_login: 'Login',
        // landing_nav_register: 'Register', // Changed from 'Register Free'
        landing_legal: 'Legal',
        landing_policy: 'Privacy Policy',
        landing_policy_desc: 'How we protect your data',
        landing_terms: 'Terms of Service',
        landing_terms_desc: 'Rules for using our service',
        ...
        up_lock_ult_t: 'ULTIMATE Feature Locked',
        up_lock_ult_d: 'This exclusive feature is only available for the ULTIMATE plan. Get full access!',
