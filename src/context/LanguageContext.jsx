...
const translations = {
    ID: {
        ...
        landing_testi1_text: 'Kirim invoice sekarang tinggal pilih klien & klik kirim via WhatsApp. Sangat praktis buat usaha saya!',
        landing_testi1_name: 'Budi Santoso',
        landing_testi1_role: 'Owner Cafe',
        landing_testi2_text: 'Fitur kasir POS-nya enteng banget di HP. Stok barang & laporan harian jadi rapi otomatis.',
        landing_testi2_name: 'Siti Aminah',
        landing_testi2_role: 'Pemilik Toko Retail',
        landing_testi3_text: 'Bisa pantau profit harian tanpa ribet buka laptop. Dashboard-nya clean & intuitif.',
    ...
    EN: {
        ...
        landing_testi1_text: 'Sending invoices is now just a few clicks via WhatsApp. Incredibly practical for my business!',
        landing_testi1_name: 'Budi Santoso',
        landing_testi1_role: 'Cafe Owner',
        landing_testi2_text: 'The POS cashier feature is smooth on mobile. Inventory and daily reports are now automated.',
        landing_testi2_name: 'Siti Aminah',
        landing_testi2_role: 'Retail Store Owner',
        landing_testi3_text: 'Monitor daily profits easily without a laptop. The dashboard is clean and intuitive.',
        landing_testi3_name: 'Andi Wijaya',
        landing_testi3_role: 'Service Business Owner',
