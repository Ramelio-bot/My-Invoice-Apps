...
import { Moon, Sun, Globe, DollarSign, Zap } from 'lucide-react';
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginLeft: 'auto' }}>
                ...
                {isPro && (
                    <div style={{
                        ...
                        color: 'white', borderRadius: 20, padding: '4px 10px',
                            ...
                            {CURRENCIES.map(c => (
                                <button
                                    ...
                                    style={{
                                        ...
                                        background: c === currency ? '#EDE9FE' : 'transparent',
                                        color: c === currency ? '#7C3AED' : (dark ? '#E2E8F0' : '#374151'),
                                    }}
                                >
                                    {c}
                                </button>
