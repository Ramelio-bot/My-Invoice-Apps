        ...
        <div style={{
            ...
            <div style={{ background: 'white', borderBottom: `1px solid #E2E8F0` }}>
                <div className="max-w-4xl mx-auto px-6 py-4 flex items-center justify-between">
                    <div>
                        <h1 className="font-bold text-lg text-slate-900">MyInvoice.space</h1>
                        ...
                        {stepsTitles.map((title, idx) => {
                            ...
                            return (
                                <div key={num} className="relative z-10 flex flex-col items-center gap-2">
                                    ...
                                    <span className={`text-xs font-semibold hidden md:block ${isActive ? 'text-violet-600' : 'text-slate-500'}`}>
                                        {title}
                                    </span>
                                </div>
                            );
            ...
            <div className="flex-1 overflow-y-auto pt-8 pb-32 px-4">
                <div className="max-w-2xl mx-auto">
                    ...
                    {step === 1 && (
                        <div className="space-y-6 animate-in slide-in-from-right-8 duration-500">
                            <div className="text-center mb-10">
                                <h2 className="text-3xl font-extrabold text-slate-900 mb-3 tracking-tight">{t('onboard_title')}</h2>
                            ...
                            <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm space-y-5">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-slate-900 focus:ring-2 focus:ring-violet-500 outline-none transition-all"
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <label className="px-4 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 font-semibold text-sm rounded-lg cursor-pointer transition-colors">
                    ...
                    {step === 2 && (
                        <div className="space-y-6 animate-in slide-in-from-right-8 duration-500">
                            <div className="text-center mb-10">
                                <h2 className="text-3xl font-extrabold text-slate-900 mb-3 tracking-tight">{t('onboard_business_type')}</h2>
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`
                                                ...
                                                ${isActive ? 'border-violet-600 bg-violet-50 text-violet-700 shadow-md shadow-violet-500/10' : 
                                                  'border-slate-200 bg-white text-slate-600 hover:border-violet-300'}
                                            `}
                                        >
                                            <div className={`p-3 rounded-full ${isActive ? 'bg-violet-100' : 'bg-slate-100'}`}>
                                                <Icon size={24} />
                                            </div>
                    ...
                    {step === 3 && (
                        <div className="space-y-6 animate-in slide-in-from-right-8 duration-500">
                            <div className="text-center mb-10">
                                <h2 className="text-3xl font-extrabold text-slate-900 mb-3 tracking-tight">{t('onboard_features')}</h2>
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`
                                                ...
                                                ${isSelected ? 'border-violet-600 bg-violet-50 shadow-md shadow-violet-500/10' : 
                                                  'border-slate-200 bg-white hover:border-violet-300'}
                                            `}
                                        >
                                            <div className={`
                                                w-6 h-6 rounded-full border-2 flex items-center justify-center shrink-0 transition-colors
                                                ${isSelected ? 'border-violet-600 bg-violet-600 text-white' : 'border-slate-300 bg-transparent'}
                                            `}>
                                            ...
                                            <div>
                                                <h3 className={`text-base font-bold mb-0.5 ${isSelected ? 'text-violet-900' : 'text-slate-700'}`}>
                                                    {feat.label}
                                                </h3>
                    ...
                    {step === 4 && (
                        <div className="space-y-6 animate-in zoom-in-95 duration-500">
                            <div className="text-center py-12 px-6 bg-white rounded-3xl border border-slate-200 shadow-xl shadow-slate-200/50">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {form.mainFeatures.map(feat => (
                                                <span key={feat} className="px-2 py-1 bg-violet-100 text-violet-700 text-xs font-bold rounded capitalize">
                                                    {feat}
                                                </span>
                                            ))}
                                        </div>
                ...
                <div className="fixed bottom-0 left-0 right-0 bg-white/80 backdrop-blur-md border-t border-slate-200 p-4 z-50">
                    <div className="max-w-4xl mx-auto flex items-center justify-between">
                        <button
                            ...
                            className="px-6 py-3 rounded-xl font-bold text-sm flex items-center gap-2 text-slate-600 hover:bg-slate-100 disabled:opacity-0 transition-all duration-300"
                        >
                        ...
                        <button
                            ...
                            className="px-8 py-3 bg-violet-600 hover:bg-violet-700 disabled:bg-slate-200 disabled:text-slate-400 disabled:cursor-not-allowed text-white rounded-xl font-bold text-sm flex items-center gap-2 shadow-lg shadow-violet-500/20 transition-all duration-300"
                        >
