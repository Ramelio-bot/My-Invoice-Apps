...
const testimonials = [
    ...
    { id: 6, name: "Anisa Putri", role: "Olshop Skincare", image: "https://randomuser.me/api/portraits/women/3.jpg", rating: 5, content: { id: "Fitur hitung HPP-nya juara! Sekarang saya tahu persis berapa margin keuntungan setiap produk.", en: "The COGS calculation feature is a winner! Now I know exactly the profit margin for each product." } },
    { id: 7, name: "Hendra Wijaya", role: "Kedai Kopi Lokal", image: "https://randomuser.me/api/portraits/men/4.jpg", rating: 5, content: { id: "Proses pembuatan dokumen cuma hitungan detik. Benar-benar menghemat waktu operasional kami.", en: "The document creation process takes only seconds. It really saves our operational time." } },
