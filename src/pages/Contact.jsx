...
export default function Contact() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        const mailtoLink = `mailto:hello.myinvoice@gmail.com?subject=${encodeURIComponent(formData.subject)} - ${encodeURIComponent(formData.name)}&body=${encodeURIComponent(formData.message)}%0A%0AFrom: ${formData.name} (${formData.email})`;
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid lg:grid-cols-5 gap-12 lg:gap-8 items-start">
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <input
                                        type="email" required
                                        className={inputClass}
                                        placeholder="hello.myinvoice@gmail.com"
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <a href="mailto:hello.myinvoice@gmail.com" className="flex items-start gap-5 p-6 rounded-2xl border transition-all hover:-translate-y-1 bg-white border-slate-200 hover:border-violet-400 hover:shadow-md">
                            ...
                            <div>
                                ...
                                <p className="font-medium text-slate-500">hello.myinvoice@gmail.com</p>
                            </div>
                        </a>
