        ...
        <div className="page-enter" style={{ padding: 24, maxWidth: 1400, margin: '0 auto' }}>
            ...
            {previewInvoice && (() => {
                ...
                return (
                    ...
                    >
                        <div style={{ background: 'white', color: '#000', borderRadius: 16, width: '95vw', maxWidth: 1000, maxHeight: '85vh', overflowY: 'auto', boxShadow: '0 24px 64px rgba(0,0,0,0.4)', animation: 'scaleIn 180ms cubic-bezier(0.4,0,0.2,1) forwards' }}>
                                {/* Sticky header */}
