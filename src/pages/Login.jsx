  ...
  */
  ...
  return (
    <div className="min-h-screen flex bg-slate-50 text-slate-900 selection:bg-violet-100 font-sans">
            ...
            {[
              ...
              <div key={i} className="flex items-center gap-5 group">
                <div className="w-6 h-6 rounded-full bg-violet-600/5 border border-violet-500/10 flex items-center justify-center shrink-0 group-hover:border-violet-500/50 transition-colors">
                  <CheckCircle size={12} className="text-violet-600" strokeWidth={4} />
                </div>
      ...
      {/* Right panel — form */}
      <div className="w-full xl:w-1/2 flex items-center justify-center p-8 relative bg-slate-50">
        <button
          onClick={toggleLang}
        ...
        <div className="w-full max-w-sm">
          <div className="mb-12 text-center xl:text-left">
            <h2 className="text-4xl font-black text-slate-950 tracking-tighter mb-3">{t('auth_login_title')}</h2>
          ...
          <div className="flex p-1.5 bg-slate-100 border border-slate-200 rounded-2xl mb-10 shadow-inner">
            <button 
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <button
              ...
              className="w-full py-5 bg-slate-950 text-white rounded-2xl font-black text-sm uppercase tracking-widest hover:bg-slate-900 disabled:opacity-50 transition-all shadow-xl active:scale-[0.98] mt-6"
            >
              {submitting ? (
          ...
          */}
          ...
          <div className="mt-16 text-center">
            <p className="text-slate-500 font-bold">
              ...
              <Link to="/register" className="text-slate-950 font-black hover:text-violet-600 transition ml-2 tracking-tight underline underline-offset-8 decoration-slate-200 hover:decoration-violet-500">
